...
const stackData = [
  {
    ...
    creatives: [
      { name: "Elliott Lee", role: "Director, Music Videos", img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&q=80" },
      { name: "Jonah Habor", role: "Creative Photographer", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&q=80" },
    ]
  },
  {
    id: 2,
    title: "Cinematographer Deck",
    location: "New York, NY",
    brandLogo: "https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=100&q=80",
    creatives: [
      { name: "Andrea Price", role: "Director of Photography", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&q=80" },
      { name: "Kelly Sorento", role: "Director, Commercials", img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&q=80" },
    ]
  },
  {
    id: 3,
    ...
    creatives: [
      { name: "Tony Fernando", role: "Executive Producer", img: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150&q=80" },
      { name: "Xulani Akel", role: "Line Producer", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&q=80" },
    ]
  }
];
...
export default function PremiumServiceGrid() {
  return (
    <section className="w-full bg-[#0D0D0D] py-24 px-6 sm:px-12 md:px-24 relative overflow-hidden select-none">
      ...
      <div className="absolute bottom-0 right-10 w-[300px] h-[300px] bg-indigo-500/[0.02] blur-[100px] pointer-events-none rounded-full z-0" />
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-start relative z-10 mx-auto">
        ...
        <div className="lg:col-span-4 lg:sticky lg:top-24 flex flex-col gap-6">
          ...
          <h2 className="text-4xl sm:text-5xl font-medium tracking-tight bg-gradient-to-b from-white via-zinc-200 to-zinc-500 bg-clip-text text-transparent leading-[1.15]">
            Top creatives.<br />Handpicked for you.
          </h2>
          <p className="text-zinc-500 text-sm sm:text-base leading-relaxed font-normal font-sans">
            Our white-glove concierge service ensures you find the perfect candidates for your job without the hassle. From one-off gigs to full time-hires.
          </p>
          
          <button className="group relative px-7 py-3.5 border border-white/10 hover:border-purple-500/40 bg-zinc-950 text-xs text-zinc-200 hover:text-white font-medium uppercase tracking-widest rounded-full self-start transition-all duration-300 shadow-[0_12px_30px_rgba(0,0,0,0.6)] hover:shadow-[0_0_30px_rgba(147,51,234,0.15)]">
            <span className="relative z-10">Contact us</span>
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500/10 to-indigo-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          </button>
        </div>
            ...
            >
              <div className="w-full flex flex-col h-full text-white">
                ...
                <div className="flex justify-between items-start border-b border-white/[0.06] pb-4 mb-4">
                  <div>
                    <span className="text-[9px] uppercase tracking-[0.15em] font-medium text-zinc-500">Position</span>
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      <span className="text-[9px] bg-white/[0.03] border border-white/[0.05] px-2 py-0.5 rounded text-zinc-400 font-normal">
                        Music Videos
                      </span>
                      <span className="text-[9px] bg-white/[0.03] border border-white/[0.05] px-2 py-0.5 rounded text-zinc-400 font-normal">
                        {page.location}
                  ...
                  <div className="w-9 h-9 rounded-full overflow-hidden border border-white/10 p-0.5 bg-zinc-950 shrink-0 shadow-md">
                    <img src={page.brandLogo} alt="brand" className="w-full h-full rounded-full object-cover filter brightness-90" />
                  </div>
                </div>
